...
class PlaceMarkerBodyState extends State<PlaceMarkerBody> {
  ...
  String rand_user_id = "unique_user_d";
  int cost = 20;
  double dest = 2.0;
  int num = 1;
  ...
  void initState() {
    ...
    GeoFirePoint center =
    geo.point(latitude:23.168819, longitude: 79.93553400000009);
        ...
        case 'local':
          switch (num) {
            ...
            case 2:
              ...
              //   tu0gg1b00   23.168809   79.9365340000001
            ...
            child: new Container(
              ...
              child: FloatingActionButton(
                ...
                onPressed: () async {
                  ...
                  GeoFirePoint geoFirePoint = geo.point(latitude: 23.168839 - num * 0.01, longitude:  79.93353400000009 + num * 0.01);
