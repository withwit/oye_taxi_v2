...
class DriverSide extends Page {
  LatLng latLng1;
  String dest;

  DriverSide({this.latLng1, this.dest})
...
class PlaceMarkerBodyState extends State<PlaceMarkerBody> {
  ...
  void initState() {
   ...
   // jbp  LatLng(23.12831529469085, 79.8717156341757);

    GeoFirePoint center =
        geo.point(latitude: 23.12831529469085, longitude: 79.8717156341757);
    ...
    BitmapDescriptor.fromAssetImage(
            ImageConfiguration(size: Size(40, 40)), 'assets/taxi.png')
        .then((onValue) {
      myIcon = onValue;
    });
    BitmapDescriptor.fromAssetImage(
  ...
  void _updateMarkers(List<DocumentSnapshot> documentList) {
    documentList.forEach((DocumentSnapshot document) {
      ...
      print("yyyyyyyyyyyyy ${point.latitude}");
      Position pos =
                      ...
                      switch (snapshot.connectionState) {
                        ...
                        default:
                          return new ListView.builder(
                              itemCount: eventCount == null ? 0 : eventCount,
                              itemBuilder: (context, index) {
                                var document = snapshot.data.documents;
                                return document.toString() == null
                                    ? Container()
                                    : My_Pass_List(document, index, context);
                              });
                      }
                    }),
              ),
              ...
              children: <Widget>[
                GoogleMap(
                  ...
                  initialCameraPosition:
                      CameraPosition(target: latLng1, zoom: 17.0, tilt: 70.0),
                      ...
                      onPressed: () async {
                        ...
                        setState(() {
                          ...
                          Firestore.instance
                              ...
                              .setData({
                            'first_driver_id': 'x',
                            'first_driver_loc': geoFirePoint.data,
                            'sec_driver_id': '',
                            'sec_driver_loc': '',
                            'requests1': "_",
                            'requests2': "_",
